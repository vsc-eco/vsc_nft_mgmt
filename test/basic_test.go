...
func TestBasicMintNFTs(t *testing.T) {
	...
	// try to mint 101 nft editions
	fmt.Println("mint 101 editions (should fail)")
	...
	fmt.Println("mint 100 editions (should not fail)")
	CallContract(t, ct, "nft_mint_edition", PayloadToJSON(map[string]any{
		"c":     0,
		"name":  "my first nft",
		"desc":  "some description",
...
func TestExtendEditionNFTs(t *testing.T) {
	...
	fmt.Println("nft_get_editions")
	CallContract(t, ct, "nft_get_editions", PayloadToJSON("0"), nil, "hive:tibfox.vsc", true, uint(1_000_000))
	// extend by 100 more nft editions
	fmt.Println("mint 100 more editions #1")
	CallContract(t, ct, "nft_mint_edition", PayloadToJSON(map[string]any{
		"c":     0,
		"name":  "my first nft",
		"desc":  "some description",
	...
	fmt.Println("mint 100 more editions #2")
	CallContract(t, ct, "nft_mint_edition", PayloadToJSON(map[string]any{
		"c":     0,
		"name":  "my first nft",
		"desc":  "some description",
	...
	fmt.Println("nft_get_editions")
	CallContract(t, ct, "nft_get_editions", PayloadToJSON("0"), nil, "hive:tibfox.vsc", true, uint(10_000_000))
	...
	CallContract(t, ct, "nft_get_creator", PayloadToJSON("hive:tibfox.vsc"), nil, "hive:tibfox.vsc", true, uint(10_000_000))
	CallContract(t, ct, "nft_get_collection", PayloadToJSON("0"), nil, "hive:tibfox.vsc", true, uint(10_000_000))
	CallContract(t, ct, "nft_get_available", PayloadToJSON("0"), nil, "hive:tibfox.vsc", true, uint(10_000_000))
}
